...
public class MetodosComRetorno {
	public static void main(String[]args){
		...
		System.out.println(MetodosComRetorno.contarLetras("Banana"));
		}
	...
	public static String mostrarDiaPorExtenso(int dia){
		...
		if(dia == 2){
			extenso = "Segunda-feira";
				...
				extenso = "Terça-feira";}else if(dia == 4){
					extenso = "Quarta-feira";
					}else if(dia == 5){
						extenso = "Quinta-feira";}
		else if(dia == 6){extenso = "Sexta-feira";}else if(dia == 7){
			extenso = "Sabado";}else{extenso = "Dia desconhecido!";}
		return extenso;} 
